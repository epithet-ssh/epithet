...
func generateConfigs(s *Server) error {
	...
	// actually-requested user (certs are strictly per-connection, never a
	// union of everything a user could reach) - since Ssh/SshWithBroker
	// always connect as s.User, that's the
