...
func TestBasics(t *testing.T) {
	...
	err = a.UseCredential(agent.Credential{
		PrivateKey:  sshcert.RawPrivateKey(_privateKey),
		Certificate: sshcert.RawCertificate(_certificate),
	})
	require.NoError(t, err)
...
const _privateKey = `-----BEGIN OPENSSH PRIVATE KEY-----
