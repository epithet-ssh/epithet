...
func init() {
	proto.RegisterType((*AuthnRequest)(nil), "rpc.AuthnRequest")
	proto.RegisterType((*AuthnResponse)(nil), "rpc.AuthnResponse")
}
...
var fileDescriptor_56ede974c0020f77 = []byte{
	...
	0x2b, 0xd1, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x2e, 0x2a, 0x48, 0x56, 0x52, 0xe1, 0xe2,
	0x71, 0x2c, 0x2d, 0xc9, 0xc8, 0x0b, 0x4a, 0x2d, 0x2c, 0x4d, 0x2d, 0x2e, 0x11, 0x12, 0xe1, 0x62,
	0x2d, 0xc9, 0xcf, 0x4e, 0xcd, 0x93, 0x60, 0x54, 0x60, 0xd4, 0xe0, 0x0c, 0x82, 0x70, 0x94, 0xf8,
	0xb9, 0x78, 0xa1, 0xaa, 0x8a, 0x0b, 0xf2, 0xf3, 0x8a, 0x53, 0x8d, 0xdc, 0xb9, 0x78, 0x1c, 0x41,
	0x46, 0x05, 0xa7, 0x16, 0x95, 0x65, 0x26, 0xa7, 0x0a, 0x99, 0x43, 0x8c, 0x49, 0xcd, 0x2b, 0xc9,
	0x4c, 0x4e, 0x2c, 0x49, 0x15, 0x12, 0xd4, 0x2b, 0x2a, 0x48, 0xd6, 0x43, 0x36, 0x59, 0x4a, 0x08,
	0x59, 0x08, 0x62, 0x8c, 0x12, 0x43, 0x12, 0x1b, 0xd8, 0x2d, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff,
	0xff, 0x78, 0xfc, 0xb2, 0x82, 0x9a, 0x00, 0x00, 0x00,
}
...
func (c *agentServiceClient) Authenticate(ctx context.Context, in *AuthnRequest, opts ...grpc.CallOption) (*AuthnResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/rpc.AgentService/Authenticate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AgentService_Authenticate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rpc.AgentService/Authenticate",
	}
