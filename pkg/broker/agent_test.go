...
func TestBroker_AgentMapInitialized(t *testing.T) {
	...
	b, err := New(*testLogger(t), socketPath, func() TokenFunc { return stubTokenFunc }, testClient(t, "http://localhost:9999"), "https://ca.example", testInventoryClient(t), testIdentityVerifier, agentSocketDir)
